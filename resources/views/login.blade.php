...
<head>
    ...
    <title>Login | HIPMI JAMBI</title>
    @vite(['resources/css/app.css','resources/js/app.js'])
</head>
<body class="m-0">
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="min-h-screen flex flex-col lg:flex-row items-center justify-center lg:gap-20 px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img src="{{asset('images/logo_hipmi.webp')}}" class="w-1/2 mx-auto lg:w-full" alt="Logo HIPMI"/>
            </a>
            <div class="w-full bg-white rounded-lg shadow-xl dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <a href="{{route('homepage')}}" class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white border-l-8 border-l-primary-600 pl-2">
                        HIPMI Jambi
                    </a>
                    <form class="space-y-4 md:space-y-6" action="{{route('auth')}}" method="post">
                        ...
                        <div class="flex items-center justify-between">
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                Belum punya akun? <a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Join HIPMI!</a>
                            </p>
