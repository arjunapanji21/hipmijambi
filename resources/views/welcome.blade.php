...
<body>
        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-center mx-auto w-full max-w-screen-2xl ">
                <a href="" class="flex items-center">
                    <img src="{{asset('images/logo_hipmi.png')}}" class="mr-3 h-9 sm:h-14" alt="Flowbite Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">HIPMI JAMBI</span>
                </a>
                <div class="flex items-center lg:order-2">
                    <a href="#"
                        class="hidden lg:flex text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Masuk</a>
                    <a href="#"
                        class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Daftar</a>
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <button id="tentangKamiLink" data-dropdown-toggle="tentangKami"
                                class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-primary-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-primary-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent">Tentang
                                Kami
                            ...
                            <!-- Dropdown menu -->
                            <div id="tentangKami"
                                class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-full lg:w-40 dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <li>
                            <a href="#"
                                class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Berita
                                & Kegiatan</a>
                        </li>
                        <li>
                            <a href="#"
    ...
    <section class="w-full max-w-screen-2xl  mx-auto bg-white dark:bg-gray-900">
        <div class="min-h-screen grid lg:grid-cols-2 gap-5">
            <div class="my-auto px-4 lg:px-8">
                <a href="#"
            ...
            <div class="">
                <img src="https://www.hipmijaya.org/wp-content/uploads/2022/04/Rectangle-18.png" alt=""
    ...
    <section class="bg-primary-700 dark:bg-primary-900">
        <div class="max-w-screen-2xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
            <dl
                class="grid lg:max-w-screen-md xl:max-w-screen-lg gap-8 mx-auto text-gray-100 sm:grid-cols-4 dark:text-white">
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl md:text-4xl font-extrabold">48</dt>
                    <dd class="font-light text-gray-200 dark:text-white">Tahun</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl md:text-4xl font-extrabold">6</dt>
                    <dd class="font-light text-gray-200 dark:text-white">Cabang</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl md:text-4xl font-extrabold">3000+</dt>
            ...
            <div class="grid lg:grid-cols-2 gap-5 items-center">
                ...
                <div class="order-1 lg:order-2">
                    <h2
                        ...
                        HIPMI (Himpunan Pengusaha Muda Indonesia) Cabang Jambi</h2>
                    <p class="mb-4 text-lg font-normal text-justify text-gray-500 lg:text-xl dark:text-gray-400">
                        Himpunan Pengusaha
                        Muda Indonesia atau HIPMI adalah organisasi independen non-partisan para pengusaha muda
                        Indonesia yang bergerak di bidang perekonomian. Organisasi ini
                        didirikan pada tanggal 10 Juni 1972 dilandasi oleh semangat untuk menumbuhkan wirausaha di
                        kalangan pemuda.</p>
                    <p class="mb-4 text-lg font-normal text-justify text-gray-500 lg:text-xl dark:text-gray-400">
                        BPC (Badang Pengurus Cabang) HIPMI Jambi merupakan cabang Himpunan Pengusaha Muda Indonesia yang berlokasi di Kota Jambi.
                    </p>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-2xl lg:py-16 lg:px-6">
            <div class="grid lg:grid-cols-2 gap-5 items-center">
                <div class="order-1">
                    <h2
                        class="mb-4 text-2xl font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-white">
                        Visi & Misi HIPMI Jambi</h2>
                    <div class="p-4 border-l-4 border-l-primary-700 ">
                        <h3 class="text-xl font-bold">Visi:</h3>
                        <p class="font-normal text-gray-500 lg:text-lg dark:text-gray-400">Menjadikan HIPMI Jambi
                            sebagai organisasi pencetak
                            pengusaha muda dan pembentuk ekosistem wirausaha terbaik di wilayah Provinsi Jambi melalui
                            program kerja yang tepat inovatif dengan semangat dan marwah organisasi HIPMI Jambi.</p>
                    </div>
                    <div class="p-4 border-l-4 border-l-primary-700 bg-gray-100">
                        <h3 class="text-xl font-bold">Misi:</h3>
                        <ol class="ps-5 space-y-1 list-decimal font-normal text-gray-500 lg:text-lg dark:text-gray-400">
                            ...
                            <li>Menyebarkan semangat kewirausahaan di wilayah Provinsi Jambi</li>
                        </ol>
                    </div>
                    </p>
                </div>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-2xl lg:py-16 lg:px-6">
            <div class="grid lg:grid-cols-2 gap-5 items-center">
                <div class="order-3 lg:order-4">
                    <h2
                        class="mb-4 text-2xl font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-white">
                        Mengapa Harus Bergabung di HIPMI Jambi ?</h2>

                    <ol
                        class="space-y-4 text-gray-500 dark:text-gray-400 border-r-4 border-r-primary-700">
                        <li class="p-4 ">
                            <span class="flex items-center -translate-x-3 text-xl font-bold"><svg class="w-5 h-5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                             </svg>
                             Koneksi-Solusi</span>
                            <ul class="ps-5 mt-2 space-y-1 text-lg">
                                <li>HIPMI akan mempertemukan Anda dengan ribuan anggota lainnya, lintas generasi dan
                                    daerah. Perluas jangkauan koneksi Anda untuk menyelesaikan tantangan kewirausahaan
                                    Anda.</li>
                            </ul>
                        </li>
                        <li class="p-4 bg-gray-100">
                            <span class="flex items-center -translate-x-3 text-xl font-bold"><svg class="w-5 h-5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                             ...
                             Kolaborasi-Kompetisi</span>
                            <ul class="ps-5 mt-2 space-y-1 text-lg">
                                <li>Petakan pesaing dan mitra usaha Anda melalui HIPMI. Bangun kolaborasi untuk
                                    memajukan usaha Anda dalam berkompetisi.</li>
                            </ul>
                        </li>
                        <li class="p-4">
                            <span class="flex items-center -translate-x-3 text-lg font-bold"><svg class="w-5 h-5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                             </svg>
                             Aktual-Kapital</span>
                            <ul class="ps-5 mt-2 space-y-1 text-lg">
                                <li>Dapatkan informasi terbaru dan kesempatan untuk terlibat dalam program-program
                                    peningkatan kapasitas khusus anggota, serta akses modal melalui mitra-mitra HIPMI
                                    Jambi.</li>
                            </ul>
                        </li>
                    </ol>
    ...
    <section class="min-h-screen bg-primary-700 dark:bg-primary-900">
        <div class="py-8 px-4 mx-auto max-w-screen-2xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div class="bg-white dark:bg-gray-900 rounded-lg px-8 py-4 shadow-lg border border-primary-300">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Pengelolaan Sumber Daya Alam</h3>
                    <p class="text-gray-500 dark:text-white">Pertambangan, Perkebunan, Pertanian, Kehutanan dan Perikanan.</p>
                </div>
                <div class="bg-white dark:bg-gray-900 rounded-lg px-8 py-4 shadow-lg border border-primary-300">
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Industri</h3>
                    <p class="text-gray-500 dark:text-gray-400">Industri Kimia, Industri Elektronika, Industri Suku Cadang otomotif, Industri Furniture.</p>
                </div>
                <div class="bg-white dark:bg-gray-900 rounded-lg px-8 py-4 shadow-lg border border-primary-300">
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Jasa</h3>
                    <p class="text-gray-500 dark:text-gray-400">Jasa Pariwisata, Jasa Konstruksi Sipil, Jasa Konsultasi, Jasa Pengadaan, Jasa Keuangan.</p>
                </div>
                <div class="bg-white dark:bg-gray-900 rounded-lg px-8 py-4 shadow-lg border border-primary-300">
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Layanan Digital</h3>
                    <p class="text-gray-500 dark:text-gray-400">Media Digital, Pendidikan Online, Kesehatan Digital, Transportasi Online, dan layanan digital lainnya.</p>
                </div>
                <div class="bg-white dark:bg-gray-900 rounded-lg px-8 py-4 shadow-lg border border-primary-300">
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Distributor</h3>
                    <p class="text-gray-500 dark:text-gray-400">Distributor Grosir, Import dan Export, Dropshipping, dan distributor lainnya.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="grid grid-cols-2 gap-4">
                ...
                <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Cerita semua kegiatan tentang HIPMI Jambi.</p>
            </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <div class="flex">
                <div>
                    <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Keanggotaan HIPMI Jambi</h2>
                </div>
                <div>
