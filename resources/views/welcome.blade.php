        ...
        <div class="min-h-screen grid lg:grid-cols-2 gap-5">
            <div class="my-auto px-10">
                ...
                <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row  sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="#"
                        class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-primary-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                        Tentang HIPMI
                    </a>
                </div>
            </div>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-2xl lg:py-16 lg:px-6">
            <div class="grid lg:grid-cols-2 gap-5 items-center">
                ...
                <div class="order-1 lg:order-2">
                    ...
                    <p class="mb-4 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">We are strategists,
                        designers and developers. Innovators and problem solvers. Small enough to be simple and quick,
                        but big enough to deliver the scope you want at the pace you need. Small enough to be simple and
    ...
    <section class="min-h-screen bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-2xl lg:py-16 lg:px-6">
            <div class="grid lg:grid-cols-2 gap-5 items-center">
                ...
                <div class="order-2">
                    <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/content/office-long-2.png" alt=""
                        class="rounded-lg h-80 w-80 lg:h-[480px] lg:w-[480px] mx-auto object-cover mb-4">
                </div>
    ...
    <section class="min-h-screen bg-primary-700 dark:bg-primary-900">
        <div class="py-8 px-4 mx-auto max-w-screen-2xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                ...
                <p class="text-gray-200 sm:text-xl dark:text-gray-400">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
            </div>
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div class="bg-white dark:bg-gray-900 rounded-lg px-8 py-4 shadow-lg border border-primary-300">
                    ...
                    <p class="text-gray-500 dark:text-white">Plan it, create it, launch it. Collaborate seamlessly with all  the organization and hit your marketing goals every month with our marketing plan.</p>
                </div>
                <div class="bg-white dark:bg-gray-900 rounded-lg px-8 py-4 shadow-lg border border-primary-300">
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
