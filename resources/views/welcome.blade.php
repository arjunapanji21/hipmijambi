            ...
            <div class="grid lg:grid-cols-2 gap-5 items-center">
                ...
                <div class="order-1 lg:order-2">
                    <h2
                        ...
                        HIPMI (Himpunan Pengusaha Muda Indonesia) Daerah Jambi</h2>
                    <p class="mb-4 text-lg font-normal text-justify text-gray-500 lg:text-xl dark:text-gray-400">
                        ...
                        Indonesia yang bergerak di bidang perekonomian.</p>
                    <p class="mb-4 text-lg font-normal text-justify text-gray-500 lg:text-xl dark:text-gray-400">
                        Organisasi ini
    ...
    <section class="min-h-screen bg-primary-700 dark:bg-primary-900">
        <div class="py-8 px-4 mx-auto max-w-screen-2xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-100 dark:text-white">Designed for
                    business teams like yours</h2>
                <p class="text-gray-200 sm:text-xl dark:text-gray-400">Here at Flowbite we focus on markets where
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div class="bg-white dark:bg-gray-900 rounded-lg px-8 py-4 shadow-lg border border-primary-300">
                    ...
                    <p class="text-gray-500 dark:text-white">Plan it, create it, launch it. Collaborate seamlessly with
